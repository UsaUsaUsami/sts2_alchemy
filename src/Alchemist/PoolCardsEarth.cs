...
public sealed class EarthRockSmash() : ElementCard(2,CardType.Attack,CardRarity.Common,TargetType.AnyEnemy,AlchemyPhase.Earth)
{
...
public sealed class EarthSandStance() : ElementCard(1,CardType.Skill,CardRarity.Common,TargetType.Self,AlchemyPhase.Earth)
{
...
public sealed class EarthIronWall() : ElementCard(2,CardType.Skill,CardRarity.Uncommon,TargetType.Self,AlchemyPhase.Earth)
{
...
public sealed class EarthVein() : ElementCard(1,CardType.Power,CardRarity.Uncommon,TargetType.Self,AlchemyPhase.Earth)
{
...
public sealed class EarthLandslide() : ElementCard(2,CardType.Attack,CardRarity.Rare,TargetType.AllEnemies,AlchemyPhase.Earth)
{
...
public sealed class EarthImmovable() : ElementCard(2,CardType.Skill,CardRarity.Rare,TargetType.Self,AlchemyPhase.Earth)
{
...
public sealed class EarthEntrench() : ElementCard(2,CardType.Skill,CardRarity.Rare,TargetType.Self,AlchemyPhase.Earth)
{
    public override bool GainsBlock=>true;
